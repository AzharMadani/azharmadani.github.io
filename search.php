               ...
               <div class="col-xl-8 col-lg-8">
                    ...
                    <?php else : ?>
                         <header class="page-header">
                              <h1 class="page-title fw-bold"><?php esc_html_e('Nothing Found', 'zyan'); ?></h1>
                         </header>
                         <p class="my-3"><?php esc_html_e('Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'zyan') ?></p>
