...
if ( !class_exists( 'Zyan_Navwalker_Class' ) ) {
    /**
     * WP_Bootstrap_Navwalker class.
     *
     * @extends Walker_Nav_Menu
     */
    class Zyan_Navwalker_Class extends Walker_Nav_Menu {
        ...
        public function start_lvl( &$output, $depth = 0, $args = [] ) {
             ...
             * @param int      $depth   Depth of menu item. Used for padding.
             */
            $class_names = join( ' ', apply_filters( 'nav_menu_droap_menu_css_class', $classes, $args, $depth ) );
        ...
        public function start_el( &$output, $item, $depth = 0, $args = [], $id = 0 ) {
            ...
            if ( isset( $args->has_children ) && $args->has_children && 0 === $depth && $args->depth > 1 ) {
                ...
                if ( $depth > 0 ) {
                    ...
                    $atts['class'] = 'nav-link text_hover_animaiton';
                }
            }
        ...
        public static function fallback( $args ) {
            if ( current_user_can( 'edit_theme_options' ) ) {
                ...
                $fallback_output .= '>';
                $fallback_output .= '<li><a href="' . esc_url( home_url( '/' ) ) . '" title="' . esc_attr__( 'Home', 'zyan' ) . '">' . esc_html__( 'Home', 'zyan' ) . '</a></li>';
                $fallback_output .= '</ul>';
                if ( $container ) {
                    $fallback_output .= '</' . esc_attr( $container ) . '>';
                }
